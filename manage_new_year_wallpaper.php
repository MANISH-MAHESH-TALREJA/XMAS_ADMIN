...
{
    $data_qry="SELECT * FROM tbl_new_year_wallpaper
    WHERE tbl_new_year_wallpaper.`wall_name` like '%".addslashes($_POST['search_value'])."%' 
    ORDER BY tbl_new_year_wallpaper.id";

    $result=mysqli_query($mysqli,$data_qry); 
}
else
{
    $tableName="tbl_new_year_wallpaper";   
    $targetpage = "manage_new_year_wallpaper.php"; 
    $limit = 12; 

    $query = "SELECT COUNT(*) as num FROM tbl_new_year_wallpaper";
    ...
    $data_qry="SELECT * FROM tbl_new_year_wallpaper
    ORDER BY tbl_new_year_wallpaper.`id` DESC LIMIT $start, $limit";
          ...
          <div class="page_title_block">
            ...
            <div class="col-md-7 col-xs-12">
              <div class="search_list">
                ...
                <div class="add_btn_primary"> <a href="add_new_year_wallpaper.php">Add Wallpaper</a> </div>
              </div>
            </div>
