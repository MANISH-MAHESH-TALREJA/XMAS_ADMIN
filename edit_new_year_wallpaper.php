<?php $page_title="Edit New YearWallpaper";
...
$qry="SELECT * FROM tbl_new_year_wallpaper WHERE `id`='".$_GET['wallpaper_id']."'";
...
if(isset($_POST['submit']))
{
    ...
    //Thumb Image 
		...
		$qry=Update('tbl_new_year_wallpaper', $data, "WHERE id = '".$_POST['wallpaper_id']."'");
	}
	else
	{
	...
	$_SESSION['msg']="11";
	header( "Location:manage_new_year_wallpaper.php?wallpaper_id=".$_POST['wallpaper_id']);
	exit;	
