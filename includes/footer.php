<footer class="app-footer">
      <div class="row">
        <div class="col-xs-12">
          <div class="footer-copyright">Copyright © <?php echo date('Y');?> <a href="http://manishtalreja.com" target="_blank">MANISH MAHESH TALREJA</a>. All Rights Reserved.</div>
        </div>
      </div>
    </footer>
  </div>
...
<script>
    ...
    $(document).on("click", ".enable_disable", function(e) {
      ...
      $.ajax({
        ...
        success: function(res) {
          Snackbar.show({msgClass: 'success',text: res.msg});
        }
      });
    });
  });
  ...
  $(document).on("click", ".actions", function(e) {
    ...
    if (_ids != '') {
      ...
      Snackbar.show({msgClass: 'success',text: 'Sorry no data selected!'});
    }
  });
